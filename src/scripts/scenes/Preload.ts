...
const team1Big: string = require('../../assets/images/team-1-big.png');
const team2Big: string = require('../../assets/images/team-2-big.png');
const team3Big: string = require('../../assets/images/team-3-big.png');
const team4Big: string = require('../../assets/images/team-4-big.png');
...
export default class Preload extends Phaser.Scene {
  ...
  private preloadAssets(): void {
    ...
    this.load.image('team-1-big', team1Big);
    this.load.image('team-2-big', team2Big);
    this.load.image('team-3-big', team3Big);
    this.load.image('team-4-big', team4Big);
