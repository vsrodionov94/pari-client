...
const copyright = 'Пора определить, чей удар самый точный!\n\nВыбирай свою команду и сразись лицом к лицу с виртуальными соперниками.\n\nЕжедневно у тебя будет по 5 жизней. Выбирай направление своих ударом с умом: чем сложнее удар – тем больше баллов, но и выше риск неудачи.\n\nНе забывай заходить в игру каждый день и зарабатывай баллы. Самый меткий игрок получит сертификат и ещё пять получат фрибеты.'
